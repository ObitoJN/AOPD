...
if __name__ == '__main__':
    ...
    if os.path.exists(output_path):
        logger.info("*** Output file already exists: {}. Skipping inference.".format(output_path))
        print("Output file already exists: {}. Skipping inference.".format(output_path))
        exit(0)
    ...
    for data in tqdm(rerank_list):
        ...
        elif "problem" in data.keys():
            input_text = data["problem"]
        else:
            raise ValueError("input text miss!")
