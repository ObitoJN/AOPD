...
class AsyncSGLangRollout(BaseRollout):
    def __init__(
        ...
        **kwargs,
        ...
        # Restrict tokens to vocabulary size to prevent generating out-of-vocabulary tokens
        vocab_size = tokenizer.vocab_size
        if vocab_size is not None:
            # Only allow token IDs within vocabulary size
            kwargs["allowed_token_ids"] = list(range(vocab_size))
            print(f"\n[AsyncSGLangRollout] Restricting allowed_token_ids to vocabulary size: {vocab_size}\n")
