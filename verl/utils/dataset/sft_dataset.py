...
class SFTDataset(Dataset):
    ...
    def __init__(self, parquet_files: Union[str, List[str]], tokenizer, config):
        ...
        # Convert OmegaConf ListConfig to plain Python list of strings
        try:
            from omegaconf import OmegaConf
            if OmegaConf.is_config(parquet_files):
    ...
    def _read_files_and_tokenize(self):
        ...
        if not self.prompt_dict_keys and len(self.prompt_key) == 1:
        ...
        if not self.response_dict_keys and len(self.response_key) == 1:
