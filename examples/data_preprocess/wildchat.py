...
tokenizer_path = "/your/local/path"
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--local_path', default='/your/local/path')
    ...
    # output_train_file = os.path.join(args.local_path,f'{data_source}/train.parquet') # 保存为Parquet文件
    # save_to_parquet(train_processed_data, output_train_file)


    print('====== check =======')
    check_file = '/your/local/path'
